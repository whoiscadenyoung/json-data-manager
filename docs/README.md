...
| [`derived-datasets-design.md`](./derived-datasets-design.md)                   | Design brainstorm for Tableau-like transformation over the catalog: transform specs → virtual derived datasets (lookup + rollup); the Projects-layer question is assessed and deferred (§9). Design only — not implemented. |
